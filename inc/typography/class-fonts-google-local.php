...
final class JobScout_Pro_Google_Local {
	 ...
	 * @return JobScout_Pro_Google_Local
	 */
	...
	public function get_root_path() {
		...
		// Return the path.
		return apply_filters( 'jobscout_pro_googlefonts_root_path', $path );
	}
	...
	public function get_root_url() {
		...
		return apply_filters( 'jobscout_pro_googlefonts_root_url', untrailingslashit( esc_url_raw( $url ) ) . '/webfonts' );
	}
