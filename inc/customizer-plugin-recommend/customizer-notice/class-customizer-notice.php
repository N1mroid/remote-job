<?php
/**
 * JobScout Pro Customizer Notification System.
 *
 ...
 */
class JobScout_Pro_Customizer_Notice {
	...
	/**
	 * The single instance of JobScout_Pro_Customizer_Notice
	 *
	 * @var JobScout_Pro_Customizer_Notice $instance The JobScout_Pro_Customizer_Notice instance.
	 */
	...
	/**
	 * The Main JobScout_Pro_Customizer_Notice instance.
	 *
	 * We make sure that only one instance of JobScout_Pro_Customizer_Notice exists in the memory at one time.
	 *
	 * @param array $config The configuration array.
	 */
	public static function init( $config ) {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof JobScout_Pro_Customizer_Notice ) ) {
			self::$instance = new JobScout_Pro_Customizer_Notice;
	...
	public function setup_config() {
		...
		$jobscout_pro_recommended_plugins = array();
		
		if ( isset( $this->recommended_plugins ) ) {
			$jobscout_pro_recommended_plugins = $this->recommended_plugins;
		}
	...
	public function scripts_for_customizer() {
		...
		wp_enqueue_script( 'jobscout-pro-customizer-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/customizer-notice/js/customizer-notice.js', array( 'jquery', 'customize-controls' ), JOBSCOUT_PRO_THEME_VERSION, true );
		wp_localize_script(
            ...
            array(
				...
				'base_path'          => admin_url(),
				'activating_string'  => __( 'Activating', 'jobscout-pro' ),
			)
		);
	}
	...
	public function customize_register_notice( $wp_customize ) {
		/**
		 * Include the JobScout_Pro_Customizer_Notice_Section class.
		 */
		...
		$wp_customize->register_section_type( 'JobScout_Pro_Customizer_Notice_Section' );

		$wp_customize->add_section(
			new JobScout_Pro_Customizer_Notice_Section(
				$wp_customize,
	...
	public function dismiss_recommended_plugins_callback() {
		...
		if ( ! empty( $action_id ) ) {
			...
			update_option( 'jobscout_pro_show_recommended_plugins', $show_recommended_plugins );
		}
